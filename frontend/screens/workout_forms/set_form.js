...
class SetForm extends React.Component {
  ...
  submitForm() {
    ...
    if (this.state.weightNumeric && this.state.repsNumeric && (this.state.weight.length > 0) && (this.state.reps.length > 0)) {
      ...
      this.props.workoutActions.receiveSet({id: temp_id, lift_id: this.props.liftId, weight: this.state.weight, reps: this.state.reps, exercise_section: this.props.exercise_section, user_id: this.props.current_user.id});
